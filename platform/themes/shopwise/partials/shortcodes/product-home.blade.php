...
{{--                                        <div class="new">New</div>--}}
                                    ...
                                    <div class="single-prodcut-img  product-overlay pos-rltv">
                                        <a href="{{ $product->url }}"> <img alt="" src="{{ RvMedia::getImageUrl($product->image, 'full', false, RvMedia::getDefaultImage()) }}"
...
{{--                                                        class="fa fa-eye"></i></a></li>--}}
                                ...
                                <div class="product-text">
                                    <div class="prodcut-name"><a href="{{ $product->url }}">{{ $product->name }}</a>
                                    </div>
