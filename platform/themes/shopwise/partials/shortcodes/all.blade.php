                ...
                <div class="total-new-arrival new-arrival-slider-active carsoule-btn row">
                        ...
                        <div class="single-product">
                            <div class="product-img">
                                ...
                                <div class="single-prodcut-img  product-overlay pos-rltv">
                                    <a href="single-product.html"> <img alt="" src="themes/shopwise/clothe/images/product/01.jpg"
                                            class="primary-image"> <img alt="" src="themes/shopwise/clothe/images/product/02.jpg"
                    ...
                    <div class="col-lg-3">
                        ...
                        <div class="single-product">
                            <div class="product-img">
                                <div class="single-prodcut-img  product-overlay pos-rltv">
                                    <a href="single-product.html"> <img alt="" src="themes/shopwise/clothe/images/product/03.jpg"
                                            class="primary-image"> <img alt="" src="themes/shopwise/clothe/images/product/04.jpg"
                                            class="secondary-image"> </a>
                                </div>
                                <div class="product-icon socile-icon-tooltip text-center">
                                    <ul>
                    ...
                    <div class="col-lg-3">
                        ...
                        <div class="single-product">
                            <div class="product-img">
                                ...
                                <div class="single-prodcut-img  product-overlay pos-rltv">
                                    <a href="single-product.html"> <img alt="" src="themes/shopwise/clothe/images/product/02.jpg"
                                            class="primary-image"> <img alt="" src="themes/shopwise/clothe/images/product/03.jpg"
                                            class="secondary-image"> </a>
                                </div>
                                <div class="product-icon socile-icon-tooltip text-center">
                                    <ul>
                    ...
                    <div class="col-lg-3">
                        ...
                        <div class="single-product">
                            <div class="product-img">
                                <div class="single-prodcut-img  product-overlay pos-rltv">
                                    <a href="single-product.html"> <img alt="" src="themes/shopwise/clothe/images/product/04.jpg"
                                            class="primary-image"> <img alt="" src="themes/shopwise/clothe/images/product/03.jpg"
                                            class="secondary-image"> </a>
                                </div>
                                <div class="product-icon socile-icon-tooltip text-center">
                    ...
                    <div class="col-lg-3">
                        ...
                        <div class="single-product">
                            <div class="product-img">
                                <div class="single-prodcut-img  product-overlay pos-rltv">
                                    <a href="single-product.html"> <img alt="" src="themes/shopwise/clothe/images/product/05.jpg"
                                            class="primary-image"> <img alt="" src="themes/shopwise/clothe/images/product/06.jpg"
                                            class="secondary-image"> </a>
                                </div>
                                <div class="product-icon socile-icon-tooltip text-center">
                                    <ul>
...
<div class="fashion-banner mt-70">
    <div class="container">
        <div class="row">
            <div class="col-lg-12">
               <div class="fashoin-banner-content">
                   <p>Full Design</p>
                    <h3>MEN’s FASHION DESTINATION</h3>
                    <h3 class="font-bold mtb-20">15% Discount</h3>
                    <a href="#" class="btn-def" tabindex="0">Shop Now</a>
               </div>
            </div>
        </div>
    </div>
</div>
<!--fashion banner area end-->
                        ...
                        <div class="col-lg-12 text-center">
                            <ul class="nav mb-40 heading-style-2" role="tablist">
                                <li role="presentation"><a class="active" href="#newarrival" aria-controls="newarrival"
                                        role="tab" data-toggle="tab">New Arrival</a>
                                </li>
                                ...
                                <li role="presentation"><a href="#specialoffer" aria-controls="specialoffer" role="tab"
                                        data-toggle="tab">Special Offer</a></li>
                            </ul>
                        </div>
                    </div>
                    <div class="clearfix"></div>
                                            ...
                                            <div class="product-img">
                                                ...
                                                <div class="single-prodcut-img  product-overlay pos-rltv">
                                                    <a href="single-product.html"> <img alt=""
                                                            src="themes/shopwise/clothe/images/product/01.jpg" class="primary-image">
                                                        <img alt="" src="themes/shopwise/clothe/images/product/02.jpg" class="secondary-image">
                                                    </a>
                                                </div>
                                                <div class="product-icon socile-icon-tooltip text-center">
                                                    <ul>
                                    ...
                                    <div class="col-lg-3">
                                        ...
                                        <div class="single-product">
                                            <div class="product-img">
                                                <div class="single-prodcut-img  product-overlay pos-rltv">
                                                    <a href="single-product.html"> <img alt=""
                                                            src="themes/shopwise/clothe/images/product/03.jpg" class="primary-image">
                                                        <img alt="" src="themes/shopwise/clothe/images/product/04.jpg" class="secondary-image">
                                                    </a>
                                                </div>
                                                <div class="product-icon socile-icon-tooltip text-center">
                                                    <ul>
                                    ...
                                    <div class="col-lg-3">
                                        ...
                                        <div class="single-product">
                                            <div class="product-img">
                                                ...
                                                <div class="single-prodcut-img  product-overlay pos-rltv">
                                                    <a href="single-product.html"> <img alt=""
                                                            src="themes/shopwise/clothe/images/product/02.jpg" class="primary-image">
                                                        <img alt="" src="themes/shopwise/clothe/images/product/03.jpg" class="secondary-image">
                                                    </a>
                                                </div>
                                                <div class="product-icon socile-icon-tooltip text-center">
                                                    <ul>
                                    ...
                                    <div class="col-lg-3">
                                        ...
                                        <div class="single-product">
                                            <div class="product-img">
                                                <div class="single-prodcut-img  product-overlay pos-rltv">
                                                    <a href="single-product.html"> <img alt=""
                                                            src="themes/shopwise/clothe/images/product/04.jpg" class="primary-image">
                                                        <img alt="" src="themes/shopwise/clothe/images/product/03.jpg" class="secondary-image">
                                                    </a>
                                                </div>
                                                <div class="product-icon socile-icon-tooltip text-center">
                                    ...
                                    <div class="col-lg-3">
                                        ...
                                        <div class="single-product">
                                            <div class="product-img">
                                                <div class="single-prodcut-img  product-overlay pos-rltv">
                                                    <a href="single-product.html"> <img alt=""
                                                            src="themes/shopwise/clothe/images/product/05.jpg" class="primary-image">
                                                        <img alt="" src="themes/shopwise/clothe/images/product/06.jpg" class="secondary-image">
                                                    </a>
                                                </div>
                                                <div class="product-icon socile-icon-tooltip text-center">
                                                    <ul>
            ...
            <div class="row">
                <div class="col-lg-12 best-heading text-center">
                       <h3>Best Product Collection</h3>
                        ...
                        <a class="view-all" href="shop.html">View all</a>
                  </div>
              </div>
         </div>
     </div>
        ...
        <div class="row">
            <div class="col-lg-3 col-md-6">
                <div class="single-service shadow-box text-center">
                    <img src="themes/shopwise/clothe/images/icons/garantee.png" alt="">
                    <h5>Money Back Guarantee</h5>
                </div>
            </div>
            <div class="col-lg-3 col-md-6">
                <div class="single-service shadow-box text-center">
                    <img src="themes/shopwise/clothe/images/icons/coupon.png" alt="">
                    <h5>Gift Coupon</h5>
                </div>
            </div>
            <div class="col-lg-3 col-md-6">
                <div class="single-service shadow-box text-center">
                    <img src="themes/shopwise/clothe/images/icons/delivery.png" alt="">
                    <h5>Free Shipping</h5>
                </div>
            </div>
            <div class="col-lg-3 col-md-6">
                <div class="single-service shadow-box text-center">
                    <img src="themes/shopwise/clothe/images/icons/support.png" alt="">
                    <h5>24x7 Support</h5>
                </div>
            </div>
        </div>
                ...
                <div class="total-testimonial active-slider carosule-pagi pagi-03">
                    <div class="single-testimonial">
                        <div class="testimonial-img">
                            <img src="themes/shopwise/clothe/images/team/testi-03.jpg" alt="">
                        </div>
                    ...
                    <div class="single-testimonial">
                        <div class="testimonial-img">
                            <img src="themes/shopwise/clothe/images/team/testi-02.jpg" alt="">
                        </div>
                        <div class="testimonial-content color-lightgrey">
                            <div class="name-degi pos-rltv">
                    ...
                    <div class="single-testimonial">
                        <div class="testimonial-img">
                            <img src="themes/shopwise/clothe/images/team/testi-01.jpg" alt="">
                        </div>
                        <div class="testimonial-content color-lightgrey">
                            <div class="name-degi pos-rltv">
                                <h5>Momen Buhyan</h5>
                    ...
                    <div class="single-ctg new-arrival-ctg">
                            ...
                            <div class="row">
                                <div class="col-lg-6 col-md-12 col-sm-6">
                                    <div class="product-ctg-img pos-rltv product-overlay">
                                        <a href="single-product.html"><img src="themes/shopwise/clothe/images/product/s01.jpg" alt=""></a>
                                    </div>
                                </div>
                                <div class="col-lg-6 col-md-12 col-sm-6">
                        ...
                        <div class="single-ctg-item">
                            <div class="row">
                                <div class="col-lg-6 col-md-12 col-sm-6">
                                    <div class="product-ctg-img pos-rltv product-overlay">
                                        <a href="single-product.html"><img src="themes/shopwise/clothe/images/product/s02.jpg" alt=""></a>
                                    </div>
                                </div>
                                <div class="col-lg-6 col-md-12 col-sm-6">
                                    <div class="product-ctg-content">
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="total-brand row">
                    <div class="col-lg-3">
                        <div class="single-brand shadow-box"><a href="#"><img src="themes/shopwise/clothe/images/brand/01.png" alt=""></a>
                        </div>
                    </div>
                    <div class="col-lg-3">
                        <div class="single-brand shadow-box"><a href="#"><img src="themes/shopwise/clothe/images/brand/02.png" alt=""></a>
                        </div>
                    </div>
                    <div class="col-lg-3">
                        <div class="single-brand shadow-box"><a href="#"><img src="themes/shopwise/clothe/images/brand/03.png" alt=""></a>
                        </div>
                    </div>
                    <div class="col-lg-3">
                        <div class="single-brand shadow-box"><a href="#"><img src="themes/shopwise/clothe/images/brand/04.png" alt=""></a>
                        </div>
                    </div>
                    <div class="col-lg-3">
                        <div class="single-brand shadow-box"><a href="#"><img src="themes/shopwise/clothe/images/brand/05.png" alt=""></a>
                        </div>
                    </div>
                    <div class="col-lg-3">
                        <div class="single-brand shadow-box"><a href="#"><img src="themes/shopwise/clothe/images/brand/06.png" alt=""></a>
                        </div>
                    </div>
                    <div class="col-lg-3">
                        <div class="single-brand shadow-box"><a href="#"><img src="themes/shopwise/clothe/images/brand/01.png" alt=""></a>
...
<div class="blog-area pb-70">
    <div class="container">
        <div class="row">
            <div class="col-lg-12 text-center">
                <div class="heading-title heading-style pos-rltv mb-50 text-center">
                    <h5 class="uppercase">Blog</h5> </div>
            </div>
            <div class="col-lg-12">
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="blog-img pos-rltv product-overlay">
                                        <a href="#"><img src="themes/shopwise/clothe/images/blog/04.jpg" alt=""></a>
                                ...
                                <div class="col-lg-6">
                                    <div class="blog-content blog-content-2">
                                        <div class="blog-title">
                                            <h5 class="uppercase"><a href="#">Creative Designer creat wonderful design</a></h5>
                                         </div>
                                            ...
                                            <a href="#" class="btn-def small montserrat mt-20">Read More</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-lg-6">
                        <div class="single-blog-2">
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="blog-img pos-rltv product-overlay">
                                        <a href="#"><img src="themes/shopwise/clothe/images/blog/05.jpg" alt=""></a>
                                        <div class="date-wraper montserrat">
                                            <span>25 </span>June
                                        </div>
                                    </div>
