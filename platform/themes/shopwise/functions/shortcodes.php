...
app()->booted(function () {
    ...
    add_shortcode('home-boxs', __('home-boxs'), __('home-boxs'), function (Shortcode $shortcode) {

        return Theme::partial('shortcodes.home-boxs', compact('shortcode'));
    });
    shortcode()->setAdminConfig('home-boxs', function (array $attributes) {

        return Theme::partial('shortcodes.home-boxs-admin-config', compact('attributes'));
    });


     add_shortcode('produce-police', __('produce police'), __('produce police'), function (Shortcode $shortcode) {

         return Theme::partial('shortcodes.produce-police', compact('shortcode'));
     });
    shortcode()->setAdminConfig('produce-police', function (array $attributes) {

        return Theme::partial('shortcodes.produce-police-admin-config', compact('attributes'));
    });
    add_shortcode('product-military', __('product-military'), __('product-military'), function (Shortcode $shortcode) {

        return Theme::partial('shortcodes.product-military', compact('shortcode'));
    });
    shortcode()->setAdminConfig('product-military', function (array $attributes) {

        return Theme::partial('shortcodes.product-military-admin-config', compact('attributes'));
    });
    add_shortcode('box-3', __('box-3'), __('box-3y'), function (Shortcode $shortcode) {

        return Theme::partial('shortcodes.box-3', compact('shortcode'));
    });
    shortcode()->setAdminConfig('box-3', function (array $attributes) {

        return Theme::partial('shortcodes.box-3-admin-config', compact('attributes'));
    });

    add_shortcode('production-process', __('production-process'), __('production-process'), function (Shortcode $shortcode) {

          return Theme::partial('shortcodes.production-process', compact('shortcode'));
      });
    shortcode()->setAdminConfig('production-process', function (array $attributes) {

        return Theme::partial('shortcodes.production-process-admin-config', compact('attributes'));
    });
    // All shortcode Castel
    add_shortcode('all', __('all'), __('all'), function (Shortcode $shortcode) {
        $categories = FaqCategory::query()
            ->wherePublished()
            ->pluck('name', 'id')
            ->all();
        return Theme::partial('shortcodes.all', compact('categories'));
    });
    ...
    shortcode()->setAdminConfig('all', function (array $attributes) {
        ...
        return Theme::partial('shortcodes.all-admin-config', compact('attributes', 'categories'));
    });

    add_shortcode('product-military-2', __('product-military-2'), __('product-military-2'), function (Shortcode $shortcode) {

        return Theme::partial('shortcodes.product-military-2', compact('shortcode'));
    });
    shortcode()->setAdminConfig('product-military-2', function (array $attributes) {

        return Theme::partial('shortcodes.product-military-2-admin-config', compact('attributes'));
    });

    add_shortcode('product-home', __('product-home'), __('product-home'), function (Shortcode $shortcode) {

        return Theme::partial('shortcodes.product-home', compact('shortcode'));
    });
    shortcode()->setAdminConfig('product-home', function (array $attributes) {
    ...
    add_shortcode('chooseus', __('chooseus'), __('chooseus'), function (Shortcode $shortcode) {

        return Theme::partial('shortcodes.chooseus', compact('shortcode'));
    });
    shortcode()->setAdminConfig('chooseus', function (array $attributes) {

        return Theme::partial('shortcodes.chooseus-admin-config', compact('attributes'));
    });

    add_shortcode('contacthead', __('contacthead'), __('contacthead'), function (Shortcode $shortcode) {

        return Theme::partial('shortcodes.contacthead', compact('shortcode'));
    });
    shortcode()->setAdminConfig('contacthead', function (array $attributes) {

        return Theme::partial('shortcodes.contacthead-admin-config', compact('attributes'));
    });
